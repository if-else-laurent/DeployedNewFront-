      ...
      <div className={AuthPageStyle.container}>
        ...
        <div className={AuthPageStyle.inner}>
          <form onSubmit={handleSubmit} className={AuthPageStyle.form}>
            ...
            <input disabled={loginLoading} required autoFocus placeholder='example@mail.com' type='email' name='email' onChange={(e) => changeHandler(e)} />
            ...
            <button disabled={loginLoading} className={AuthPageStyle.button}> Login </button>
          </form>
        </div>
      </div>
